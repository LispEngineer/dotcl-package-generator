...
"
  (cl:cond
    ...
    ((cl:and supplied-value (cl:or (cl:null value) (dotnet:is-instance-of value "System.ReadOnlySpan`1[[System.Single, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]], System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e")) (cl:not supplied-y))
     (dotnet:new <type-str> value))
...
"
  (cl:cond
    ((cl:and (cl:or (cl:null value) (dotnet:is-instance-of value "System.Numerics.Vector2")) supplied-right (cl:or (cl:null right) (dotnet:is-instance-of right "System.Numerics.Vector2")))
     (dotnet:static <type-str> "op_Subtraction" value right))
    ((cl:and (cl:or (cl:null value) (dotnet:is-instance-of value "System.Numerics.Vector2")) (cl:not supplied-right))
...
"
  (cl:cond
    ((cl:and (cl:or (cl:null left) (dotnet:is-instance-of left "System.Numerics.Vector2")) (cl:or (cl:null right) (dotnet:is-instance-of right "System.Numerics.Vector2")))
     (dotnet:static <type-str> "op_Multiply" left right))
    ((cl:and (cl:or (cl:null left) (dotnet:is-instance-of left "System.Numerics.Vector2")) (cl:numberp right))
     (dotnet:static <type-str> "op_Multiply" left right))
    ((cl:and (cl:numberp left) (cl:or (cl:null right) (dotnet:is-instance-of right "System.Numerics.Vector2")))
     (dotnet:static <type-str> "op_Multiply" left right))
    (cl:t (cl:error 'csharp-assembly-utils:csharp-overload-not-found
                    :package-name "SYSTEM-NUMERICS-VECTOR2"
                    :class-name <type-str>
...
"
  (dotnet:static <type-str> "op_BitwiseAnd" (cl:the (dotnet "System.Numerics.Vector2") left) (cl:the (dotnet "System.Numerics.Vector2") right)))
...
(cl:defun ^ (left right)
  ...
  - right (System.Numerics.Vector2): 
"
  (dotnet:static <type-str> "op_ExclusiveOr" (cl:the (dotnet "System.Numerics.Vector2") left) (cl:the (dotnet "System.Numerics.Vector2") right)))
...
"
  (dotnet:static <type-str> "op_LeftShift" (cl:the (dotnet "System.Numerics.Vector2") value) (cl:the (dotnet "System.Int32") shift-amount)))
...
(cl:defun >> (value shift-amount)
  ...
  - shift-amount (System.Int32): 
"
  (dotnet:static <type-str> "op_RightShift" (cl:the (dotnet "System.Numerics.Vector2") value) (cl:the (dotnet "System.Int32") shift-amount)))
...
(cl:defun ~ (value)
  ...
  - value (System.Numerics.Vector2): 
"
  (dotnet:static <type-str> "op_OnesComplement" (cl:the (dotnet "System.Numerics.Vector2") value)))
...
"
  (cl:cond
    ...
    ((cl:and (cl:or (cl:null value) (dotnet:is-instance-of value "System.ReadOnlySpan`1[[System.Single, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]], System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e")) (cl:not supplied-y))
...
"
  (cl:cond
    ...
    ((cl:and (cl:or (cl:null obj) (dotnet:is-instance-of obj "System.Numerics.Vector2")))
     (dotnet:invoke (cl:the (dotnet "System.Numerics.Vector2") obj!) "Equals" obj))
    (cl:t (cl:error 'csharp-assembly-utils:csharp-overload-not-found
                    :package-name "SYSTEM-NUMERICS-VECTOR2"
                    :class-name <type-str>
...
"
  (cl:cond
    ((cl:and (cl:or (cl:null value1) (dotnet:is-instance-of value1 "System.Numerics.Vector2")) (cl:or (cl:null value2) (dotnet:is-instance-of value2 "System.Numerics.Vector2")) (cl:numberp amount))
     (dotnet:static <type-str> "Lerp" value1 value2 amount))
    ((cl:and (cl:or (cl:null value1) (dotnet:is-instance-of value1 "System.Numerics.Vector2")) (cl:or (cl:null value2) (dotnet:is-instance-of value2 "System.Numerics.Vector2")) (cl:or (cl:null amount) (dotnet:is-instance-of amount "System.Numerics.Vector2")))
     (dotnet:static <type-str> "Lerp" value1 value2 amount))
    (cl:t (cl:error 'csharp-assembly-utils:csharp-overload-not-found
                    :package-name "SYSTEM-NUMERICS-VECTOR2"
                    :class-name <type-str>
...
"
  (cl:cond
    ((cl:and (cl:or (cl:null vector) (dotnet:is-instance-of vector "System.Numerics.Vector2")) supplied-mode (cl:or (cl:null mode) (dotnet:is-instance-of mode "System.MidpointRounding")))
     (dotnet:static <type-str> "Round" vector mode))
    ((cl:and (cl:or (cl:null vector) (dotnet:is-instance-of vector "System.Numerics.Vector2")) (cl:not supplied-mode))
...
"
  (cl:cond
    ((cl:and (cl:or (cl:null position) (dotnet:is-instance-of position "System.Numerics.Vector2")) (cl:or (cl:null matrix) (dotnet:is-instance-of matrix "System.Numerics.Matrix3x2")))
...
"
  (cl:cond
    ((cl:and (cl:or (cl:null normal) (dotnet:is-instance-of normal "System.Numerics.Vector2")) (cl:or (cl:null matrix) (dotnet:is-instance-of matrix "System.Numerics.Matrix3x2")))
     (dotnet:static <type-str> "TransformNormal" normal matrix))
    ((cl:and (cl:or (cl:null normal) (dotnet:is-instance-of normal "System.Numerics.Vector2")) (cl:or (cl:null matrix) (dotnet:is-instance-of matrix "System.Numerics.Matrix4x4")))
     (dotnet:static <type-str> "TransformNormal" normal matrix))
    (cl:t (cl:error 'csharp-assembly-utils:csharp-overload-not-found
                    :package-name "SYSTEM-NUMERICS-VECTOR2"
                    :class-name <type-str>
...
;; Extension methods (exact match on this == System.Numerics.Vector2):
;;   System.Numerics.Vector::StoreUnsafe(Vector2, ref Single&) -> Void -- skipped (special parameter types (ref/out/params/default) not yet supported)
;;   System.Numerics.Vector::StoreUnsafe(Vector2, ref Single&, UIntPtr) -> Void -- skipped (special parameter types (ref/out/params/default) not yet supported)
(cl:defun as-vector3 (obj!)
  "Extension method from System.Numerics.Vector (assembly System.Numerics.Vectors.dll).
Summary: Reinterprets a System.Numerics.Vector2 to a new System.Numerics.Vector3 with the new elements zeroed.
Returns: value reinterpreted to a new System.Numerics.Vector3 with the new elements zeroed.
"
  (dotnet:static "System.Numerics.Vector" "AsVector3" obj!))

(cl:defun as-vector3-unsafe (obj!)
  "Extension method from System.Numerics.Vector (assembly System.Numerics.Vectors.dll).
Summary: Reinterprets a System.Numerics.Vector2 to a new System.Numerics.Vector3 with the new elements undefined.
Returns: value reinterpreted to a new System.Numerics.Vector3 with the new elements undefined.
"
  (dotnet:static "System.Numerics.Vector" "AsVector3Unsafe" obj!))

(cl:defun as-vector4 (obj!)
  "Extension method from System.Numerics.Vector (assembly System.Numerics.Vectors.dll).
Summary: Reinterprets a System.Numerics.Vector2 to a new System.Numerics.Vector4 with the new elements zeroed.
Returns: value reinterpreted to a new System.Numerics.Vector4 with the new elements zeroed.
"
  (dotnet:static "System.Numerics.Vector" "AsVector4" obj!))

(cl:defun as-vector4-unsafe (obj!)
  "Extension method from System.Numerics.Vector (assembly System.Numerics.Vectors.dll).
Summary: Reinterprets a System.Numerics.Vector2 to a new System.Numerics.Vector4 with the new elements undefined.
Returns: value reinterpreted to a new System.Numerics.Vector4 with the new elements undefined.
"
