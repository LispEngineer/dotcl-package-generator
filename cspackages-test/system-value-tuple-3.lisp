...
"
  (cl:cond
    ((cl:and supplied-item1 (cl:or (cl:null item1) (dotnet:is-instance-of item1 "T1")) supplied-item2 (cl:or (cl:null item2) (dotnet:is-instance-of item2 "T2")) supplied-item3 (cl:or (cl:null item3) (dotnet:is-instance-of item3 "T3")))
...
"
  (cl:cond
    ...
    ((cl:and (cl:or (cl:null obj) (dotnet:is-instance-of obj "System.ValueTuple`3[T1, T2, T3]")))
     (dotnet:invoke (cl:the (dotnet "System.ValueTuple`3") obj!) "Equals" obj))
    (cl:t (cl:error 'csharp-assembly-utils:csharp-overload-not-found
                    :package-name "SYSTEM-VALUE-TUPLE-3"
                    :class-name <type-str>
