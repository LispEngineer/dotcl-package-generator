...
(cl:eval-when (:compile-toplevel :load-toplevel :execute)
  (dotnet:static "DotCL.Runtime" "EnsureDotNetTypeClass"
                 (dotnet:resolve-type "System.ValueTuple`6")))
...
new(T1, T2, T3, T4, T5, T6)
  Summary: Initializes a new System.ValueTuple`6 instance.
  Parameters:
...
"
  (cl:cond
    ...
    (cl:t (cl:error 'csharp-assembly-utils:csharp-overload-not-found
                    ...
                    :class-name <type-str>
                    :method-name "new"
                    :supplied-args (cl:append (cl:when supplied-item1 (cl:list :item1 item1)) (cl:when supplied-item2 (cl:list :item2 item2)) (cl:when supplied-item3 (cl:list :item3 item3)) (cl:when supplied-item4 (cl:list :item4 item4)) (cl:when supplied-item5 (cl:list :item5 item5)) (cl:when supplied-item6 (cl:list :item6 item6)))))))
...
(cl:defun compare-to (obj! other)
  "Summary: Compares the current System.ValueTuple`6 instance to a specified System.ValueTuple`6 instance.
...
Parameters:
  - other (System.ValueTuple`6[T1, T2, T3, T4, T5, T6]): The tuple to compare with this instance.
"
  (dotnet:invoke (cl:the (dotnet "System.ValueTuple`6") obj!) "CompareTo" other))

(cl:defun equals (obj! obj)
  "Master wrapper for System.ValueTuple`6.Equals overloads. Dispatches at runtime.

Equals(Object) -> Boolean
  Summary: Returns a value that indicates whether the current System.ValueTuple`6 instance is equal to a specified object.
...
Equals(ValueTuple) -> Boolean
  Summary: Returns a value that indicates whether the current System.ValueTuple`6 instance is equal to a specified System.ValueTuple`6 instance.
...
(cl:defun get-hash-code (obj!)
  "Summary: Calculates the hash code for the current System.ValueTuple`6 instance.
Returns: The hash code for the current System.ValueTuple`6 instance.
"
  (dotnet:invoke (cl:the (dotnet "System.ValueTuple`6") obj!) "GetHashCode"))

(cl:defun to-string (obj!)
  "Summary: Returns a string that represents the value of this System.ValueTuple`6 instance.
Returns: The string representation of this System.ValueTuple`6 instance.
"
  (dotnet:invoke (cl:the (dotnet "System.ValueTuple`6") obj!) "ToString"))
