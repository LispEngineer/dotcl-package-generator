...
;;; Generator Version: 19
;;; Creation Date: 2026-07-03T05:03:00Z
...
(cl:defconstant <creation> "2026-07-03T05:03:00Z")
(cl:defconstant <version> 19)

;; Register C# Type with CLOS
(cl:eval-when (:compile-toplevel :load-toplevel :execute)
  (dotnet:static "DotCL.Runtime" "EnsureDotNetTypeClass"
                 (dotnet:resolve-type "System.Xml.XmlReader")))
...
(cl:defun create-string (input-uri)
  "Calls System.Xml.XmlReader.Create Create(String) -> XmlReader. Summary: Creates a new System.Xml.XmlReader instance with specified URI.
...
"
  (dotnet:static <type-str> "Create" (cl:the (dotnet "System.String") input-uri)))

(cl:defun create-stream (input)
  "Calls System.Xml.XmlReader.Create Create(Stream) -> XmlReader. Summary: Creates a new System.Xml.XmlReader instance using the specified stream with default settings.
Returns: An object that is used to read the XML data in the stream.
Parameters:
...
"
  (dotnet:static <type-str> "Create" (cl:the (dotnet "System.IO.Stream") input)))

(cl:defun create-text-reader (input)
  "Calls System.Xml.XmlReader.Create Create(TextReader) -> XmlReader. Summary: Creates a new System.Xml.XmlReader instance by using the specified text reader.
Returns: An object that is used to read the XML data in the stream.
Parameters:
...
"
  (dotnet:static <type-str> "Create" (cl:the (dotnet "System.IO.TextReader") input)))

(cl:defun create-string-xml-reader-settings (input-uri settings)
  "Calls System.Xml.XmlReader.Create Create(String, XmlReaderSettings) -> XmlReader. Summary: Creates a new System.Xml.XmlReader instance by using the specified URI and settings.
Returns: An object that is used to read the XML data in the stream.
Parameters:
...
"
  (dotnet:static <type-str> "Create" (cl:the (dotnet "System.String") input-uri) (cl:the (dotnet "System.Xml.XmlReaderSettings") settings)))

(cl:defun create-stream-xml-reader-settings (input settings)
  "Calls System.Xml.XmlReader.Create Create(Stream, XmlReaderSettings) -> XmlReader. Summary: Creates a new System.Xml.XmlReader instance with the specified stream and settings.
Returns: An object that is used to read the XML data in the stream.
Parameters:
  - input (System.IO.Stream): The stream that contains the XML data. The System.Xml.XmlReader scans the first bytes of the stream looking for a byte order mark or other sign of encoding. When encoding is determined, the encoding is used to continue reading the stream, and processing continues parsing the input as a stream of (Unicode) characters.
  - settings (System.Xml.XmlReaderSettings): The settings for the new System.Xml.XmlReader instance. This value can be .
"
  (dotnet:static <type-str> "Create" (cl:the (dotnet "System.IO.Stream") input) (cl:the (dotnet "System.Xml.XmlReaderSettings") settings)))

(cl:defun create-text-reader-xml-reader-settings (input settings)
  "Calls System.Xml.XmlReader.Create Create(TextReader, XmlReaderSettings) -> XmlReader. Summary: Creates a new System.Xml.XmlReader instance by using the specified text reader and settings.
Returns: An object that is used to read the XML data in the stream.
Parameters:
...
"
  (dotnet:static <type-str> "Create" (cl:the (dotnet "System.IO.TextReader") input) (cl:the (dotnet "System.Xml.XmlReaderSettings") settings)))

(cl:defun create-xml-reader-xml-reader-settings (reader settings)
  "Calls System.Xml.XmlReader.Create Create(XmlReader, XmlReaderSettings) -> XmlReader. Summary: Creates a new System.Xml.XmlReader instance by using the specified XML reader and settings.
...
"
  (dotnet:static <type-str> "Create" (cl:the (dotnet "System.Xml.XmlReader") reader) (cl:the (dotnet "System.Xml.XmlReaderSettings") settings)))

(cl:defun create-string-xml-reader-settings-xml-parser-context (input-uri settings input-context)
  "Calls System.Xml.XmlReader.Create Create(String, XmlReaderSettings, XmlParserContext) -> XmlReader. Summary: Creates a new System.Xml.XmlReader instance by using the specified URI, settings, and context information for parsing.
Returns: An object that is used to read the XML data in the stream.
Parameters:
  - input-uri (System.String): The URI for the file containing the XML data. The System.Xml.XmlResolver object on the System.Xml.XmlReaderSettings object is used to convert the path to a canonical data representation. If System.Xml.XmlReaderSettings.XmlResolver is , a new System.Xml.XmlUrlResolver object is used.
  - settings (System.Xml.XmlReaderSettings): The settings for the new System.Xml.XmlReader instance. This value can be .
...
"
  (dotnet:static <type-str> "Create" (cl:the (dotnet "System.String") input-uri) (cl:the (dotnet "System.Xml.XmlReaderSettings") settings) (cl:the (dotnet "System.Xml.XmlParserContext") input-context)))

(cl:defun create-stream-xml-reader-settings-string (input settings base-uri)
  "Calls System.Xml.XmlReader.Create Create(Stream, XmlReaderSettings, String) -> XmlReader. Summary: Creates a new System.Xml.XmlReader instance using the specified stream, base URI, and settings.
Returns: An object that is used to read the XML data in the stream.
Parameters:
  - input (System.IO.Stream): The stream that contains the XML data. The System.Xml.XmlReader scans the first bytes of the stream looking for a byte order mark or other sign of encoding. When encoding is determined, the encoding is used to continue reading the stream, and processing continues parsing the input as a stream of (Unicode) characters.
  - settings (System.Xml.XmlReaderSettings): The settings for the new System.Xml.XmlReader instance. This value can be .
...
"
  (dotnet:static <type-str> "Create" (cl:the (dotnet "System.IO.Stream") input) (cl:the (dotnet "System.Xml.XmlReaderSettings") settings) (cl:the (dotnet "System.String") base-uri)))

(cl:defun create-stream-xml-reader-settings-xml-parser-context (input settings input-context)
  "Calls System.Xml.XmlReader.Create Create(Stream, XmlReaderSettings, XmlParserContext) -> XmlReader. Summary: Creates a new System.Xml.XmlReader instance using the specified stream, settings, and context information for parsing.
Returns: An object that is used to read the XML data in the stream.
Parameters:
  - input (System.IO.Stream): The stream that contains the XML data. The System.Xml.XmlReader scans the first bytes of the stream looking for a byte order mark or other sign of encoding. When encoding is determined, the encoding is used to continue reading the stream, and processing continues parsing the input as a stream of (Unicode) characters.
  - settings (System.Xml.XmlReaderSettings): The settings for the new System.Xml.XmlReader instance. This value can be .
  - input-context (System.Xml.XmlParserContext): The context information required to parse the XML fragment. The context information can include the System.Xml.XmlNameTable to use, encoding, namespace scope, the current xml:lang and xml:space scope, base URI, and document type definition. This value can be .
"
  (dotnet:static <type-str> "Create" (cl:the (dotnet "System.IO.Stream") input) (cl:the (dotnet "System.Xml.XmlReaderSettings") settings) (cl:the (dotnet "System.Xml.XmlParserContext") input-context)))

(cl:defun create-text-reader-xml-reader-settings-string (input settings base-uri)
  "Calls System.Xml.XmlReader.Create Create(TextReader, XmlReaderSettings, String) -> XmlReader. Summary: Creates a new System.Xml.XmlReader instance by using the specified text reader, settings, and base URI.
Returns: An object that is used to read the XML data in the stream.
Parameters:
  ...
  - base-uri (System.String): The base URI for the entity or document being read. This value can be . Security Note The base URI is used to resolve the relative URI of the XML document. Do not use a base URI from an untrusted source.
"
  (dotnet:static <type-str> "Create" (cl:the (dotnet "System.IO.TextReader") input) (cl:the (dotnet "System.Xml.XmlReaderSettings") settings) (cl:the (dotnet "System.String") base-uri)))

(cl:defun create-text-reader-xml-reader-settings-xml-parser-context (input settings input-context)
  "Calls System.Xml.XmlReader.Create Create(TextReader, XmlReaderSettings, XmlParserContext) -> XmlReader. Summary: Creates a new System.Xml.XmlReader instance by using the specified text reader, settings, and context information for parsing.
Returns: An object that is used to read the XML data in the stream.
Parameters:
  - input (System.IO.TextReader): The text reader from which to read the XML data. A text reader returns a stream of Unicode characters, so the encoding specified in the XML declaration isn't used by the XML reader to decode the data stream.
  - settings (System.Xml.XmlReaderSettings): The settings for the new System.Xml.XmlReader instance. This value can be .
  - input-context (System.Xml.XmlParserContext): The context information required to parse the XML fragment. The context information can include the System.Xml.XmlNameTable to use, encoding, namespace scope, the current xml:lang and xml:space scope, base URI, and document type definition. This value can be .
"
  (dotnet:static <type-str> "Create" (cl:the (dotnet "System.IO.TextReader") input) (cl:the (dotnet "System.Xml.XmlReaderSettings") settings) (cl:the (dotnet "System.Xml.XmlParserContext") input-context)))
...
(cl:defun dispose (obj)
  "Calls System.Xml.XmlReader.Dispose Dispose() -> Void. Summary: Releases all resources used by the current instance of the System.Xml.XmlReader class.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "Dispose"))

(cl:defun dispose-boolean (obj disposing)
  "Calls System.Xml.XmlReader.Dispose Dispose(Boolean) -> Void. Summary: Releases the unmanaged resources used by the System.Xml.XmlReader and optionally releases the managed resources.
Parameters:
...
(cl:defun get-attribute-string (obj name)
  "Calls System.Xml.XmlReader.GetAttribute GetAttribute(String) -> String. Summary: When overridden in a derived class, gets the value of the attribute with the specified System.Xml.XmlReader.Name.
...
(cl:defun get-attribute-int32 (obj i)
  "Calls System.Xml.XmlReader.GetAttribute GetAttribute(Int32) -> String. Summary: When overridden in a derived class, gets the value of the attribute with the specified index.
...
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "GetAttribute" i))

(cl:defun get-attribute-string-string (obj name namespace-uri)
  "Calls System.Xml.XmlReader.GetAttribute GetAttribute(String, String) -> String. Summary: When overridden in a derived class, gets the value of the attribute with the specified System.Xml.XmlReader.LocalName and System.Xml.XmlReader.NamespaceURI.
...
(cl:defun start-element? (obj)
  "Calls System.Xml.XmlReader.IsStartElement IsStartElement() -> Boolean. Summary: Calls System.Xml.XmlReader.MoveToContent and tests if the current content node is a start tag or empty element tag.
Returns: if System.Xml.XmlReader.MoveToContent finds a start tag or empty element tag; if a node type other than was found.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "IsStartElement"))

(cl:defun start-element?-string (obj name)
  "Calls System.Xml.XmlReader.IsStartElement IsStartElement(String) -> Boolean. Summary: Calls System.Xml.XmlReader.MoveToContent and tests if the current content node is a start tag or empty element tag and if the System.Xml.XmlReader.Name property of the element found matches the given argument.
...
(cl:defun start-element?-string-string (obj localname ns)
  "Calls System.Xml.XmlReader.IsStartElement IsStartElement(String, String) -> Boolean. Summary: Calls System.Xml.XmlReader.MoveToContent and tests if the current content node is a start tag or empty element tag and if the System.Xml.XmlReader.LocalName and System.Xml.XmlReader.NamespaceURI properties of the element found match the given strings.
...
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "IsStartElement" localname ns))
...
(cl:defun move-to-attribute-string (obj name)
  "Calls System.Xml.XmlReader.MoveToAttribute MoveToAttribute(String) -> Boolean. Summary: When overridden in a derived class, moves to the attribute with the specified System.Xml.XmlReader.Name.
...
(cl:defun move-to-attribute-int32 (obj i)
  "Calls System.Xml.XmlReader.MoveToAttribute MoveToAttribute(Int32) -> Void. Summary: When overridden in a derived class, moves to the attribute with the specified index.
Parameters:
  - i (System.Int32): The index of the attribute.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "MoveToAttribute" i))

(cl:defun move-to-attribute-string-string (obj name ns)
  "Calls System.Xml.XmlReader.MoveToAttribute MoveToAttribute(String, String) -> Boolean. Summary: When overridden in a derived class, moves to the attribute with the specified System.Xml.XmlReader.LocalName and System.Xml.XmlReader.NamespaceURI.
Returns: if the attribute is found; otherwise, . If , the reader's position does not change.
Parameters:
  - name (System.String): The local name of the attribute.
...
(cl:defun read-element-content-as-type-i-xml-namespace-resolver (obj return-type namespace-resolver)
  "Calls System.Xml.XmlReader.ReadElementContentAs ReadElementContentAs(Type, IXmlNamespaceResolver) -> Object. Summary: Reads the element content as the requested type.
...
(cl:defun read-element-content-as-type-i-xml-namespace-resolver-string-string (obj return-type namespace-resolver local-name namespace-uri)
  "Calls System.Xml.XmlReader.ReadElementContentAs ReadElementContentAs(Type, IXmlNamespaceResolver, String, String) -> Object. Summary: Checks that the specified local name and namespace URI matches that of the current element, then reads the element content as the requested type.
Returns: The element content converted to the requested typed object.
Parameters:
  - return-type (System.Type): The type of the value to be returned. Note With the release of the .NET Framework 3.5, the value of the returnType parameter can now be the System.DateTimeOffset type.
  - namespace-resolver (System.Xml.IXmlNamespaceResolver): An System.Xml.IXmlNamespaceResolver object that is used to resolve any namespace prefixes related to type conversion.
...
(cl:defun read-element-content-as-boolean (obj)
  "Calls System.Xml.XmlReader.ReadElementContentAsBoolean ReadElementContentAsBoolean() -> Boolean. Summary: Reads the current element and returns the contents as a System.Boolean object.
Returns: The element content as a System.Boolean object.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadElementContentAsBoolean"))

(cl:defun read-element-content-as-boolean-string-string (obj local-name namespace-uri)
  "Calls System.Xml.XmlReader.ReadElementContentAsBoolean ReadElementContentAsBoolean(String, String) -> Boolean. Summary: Checks that the specified local name and namespace URI matches that of the current element, then reads the current element and returns the contents as a System.Boolean object.
Returns: The element content as a System.Boolean object.
Parameters:
  - local-name (System.String): The local name of the element.
  - namespace-uri (System.String): The namespace URI of the element.
...
(cl:defun read-element-content-as-date-time (obj)
  "Calls System.Xml.XmlReader.ReadElementContentAsDateTime ReadElementContentAsDateTime() -> DateTime. Summary: Reads the current element and returns the contents as a System.DateTime object.
Returns: The element content as a System.DateTime object.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadElementContentAsDateTime"))

(cl:defun read-element-content-as-date-time-string-string (obj local-name namespace-uri)
  "Calls System.Xml.XmlReader.ReadElementContentAsDateTime ReadElementContentAsDateTime(String, String) -> DateTime. Summary: Checks that the specified local name and namespace URI matches that of the current element, then reads the current element and returns the contents as a System.DateTime object.
...
(cl:defun read-element-content-as-decimal (obj)
  "Calls System.Xml.XmlReader.ReadElementContentAsDecimal ReadElementContentAsDecimal() -> Decimal. Summary: Reads the current element and returns the contents as a System.Decimal object.
Returns: The element content as a System.Decimal object.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadElementContentAsDecimal"))

(cl:defun read-element-content-as-decimal-string-string (obj local-name namespace-uri)
  "Calls System.Xml.XmlReader.ReadElementContentAsDecimal ReadElementContentAsDecimal(String, String) -> Decimal. Summary: Checks that the specified local name and namespace URI matches that of the current element, then reads the current element and returns the contents as a System.Decimal object.
Returns: The element content as a System.Decimal object.
Parameters:
  - local-name (System.String): The local name of the element.
  - namespace-uri (System.String): The namespace URI of the element.
...
(cl:defun read-element-content-as-double (obj)
  "Calls System.Xml.XmlReader.ReadElementContentAsDouble ReadElementContentAsDouble() -> Double. Summary: Reads the current element and returns the contents as a double-precision floating-point number.
Returns: The element content as a double-precision floating-point number.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadElementContentAsDouble"))

(cl:defun read-element-content-as-double-string-string (obj local-name namespace-uri)
  "Calls System.Xml.XmlReader.ReadElementContentAsDouble ReadElementContentAsDouble(String, String) -> Double. Summary: Checks that the specified local name and namespace URI matches that of the current element, then reads the current element and returns the contents as a double-precision floating-point number.
Returns: The element content as a double-precision floating-point number.
Parameters:
  - local-name (System.String): The local name of the element.
  - namespace-uri (System.String): The namespace URI of the element.
...
(cl:defun read-element-content-as-float (obj)
  "Calls System.Xml.XmlReader.ReadElementContentAsFloat ReadElementContentAsFloat() -> Single. Summary: Reads the current element and returns the contents as single-precision floating-point number.
Returns: The element content as a single-precision floating point number.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadElementContentAsFloat"))

(cl:defun read-element-content-as-float-string-string (obj local-name namespace-uri)
  "Calls System.Xml.XmlReader.ReadElementContentAsFloat ReadElementContentAsFloat(String, String) -> Single. Summary: Checks that the specified local name and namespace URI matches that of the current element, then reads the current element and returns the contents as a single-precision floating-point number.
Returns: The element content as a single-precision floating point number.
Parameters:
  - local-name (System.String): The local name of the element.
  - namespace-uri (System.String): The namespace URI of the element.
...
(cl:defun read-element-content-as-int (obj)
  "Calls System.Xml.XmlReader.ReadElementContentAsInt ReadElementContentAsInt() -> Int32. Summary: Reads the current element and returns the contents as a 32-bit signed integer.
Returns: The element content as a 32-bit signed integer.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadElementContentAsInt"))

(cl:defun read-element-content-as-int-string-string (obj local-name namespace-uri)
  "Calls System.Xml.XmlReader.ReadElementContentAsInt ReadElementContentAsInt(String, String) -> Int32. Summary: Checks that the specified local name and namespace URI matches that of the current element, then reads the current element and returns the contents as a 32-bit signed integer.
Returns: The element content as a 32-bit signed integer.
Parameters:
  - local-name (System.String): The local name of the element.
  - namespace-uri (System.String): The namespace URI of the element.
...
(cl:defun read-element-content-as-long (obj)
  "Calls System.Xml.XmlReader.ReadElementContentAsLong ReadElementContentAsLong() -> Int64. Summary: Reads the current element and returns the contents as a 64-bit signed integer.
Returns: The element content as a 64-bit signed integer.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadElementContentAsLong"))

(cl:defun read-element-content-as-long-string-string (obj local-name namespace-uri)
  "Calls System.Xml.XmlReader.ReadElementContentAsLong ReadElementContentAsLong(String, String) -> Int64. Summary: Checks that the specified local name and namespace URI matches that of the current element, then reads the current element and returns the contents as a 64-bit signed integer.
Returns: The element content as a 64-bit signed integer.
Parameters:
  - local-name (System.String): The local name of the element.
  - namespace-uri (System.String): The namespace URI of the element.
...
(cl:defun read-element-content-as-object (obj)
  "Calls System.Xml.XmlReader.ReadElementContentAsObject ReadElementContentAsObject() -> Object. Summary: Reads the current element and returns the contents as an System.Object.
...
(cl:defun read-element-content-as-object-string-string (obj local-name namespace-uri)
  "Calls System.Xml.XmlReader.ReadElementContentAsObject ReadElementContentAsObject(String, String) -> Object. Summary: Checks that the specified local name and namespace URI matches that of the current element, then reads the current element and returns the contents as an System.Object.
Returns: A boxed common language runtime (CLR) object of the most appropriate type. The System.Xml.XmlReader.ValueType property determines the appropriate CLR type. If the content is typed as a list type, this method returns an array of boxed objects of the appropriate type.
Parameters:
  - local-name (System.String): The local name of the element.
  - namespace-uri (System.String): The namespace URI of the element.
...
(cl:defun read-element-content-as-string (obj)
  "Calls System.Xml.XmlReader.ReadElementContentAsString ReadElementContentAsString() -> String. Summary: Reads the current element and returns the contents as a System.String object.
Returns: The element content as a System.String object.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadElementContentAsString"))

(cl:defun read-element-content-as-string-string-string (obj local-name namespace-uri)
  "Calls System.Xml.XmlReader.ReadElementContentAsString ReadElementContentAsString(String, String) -> String. Summary: Checks that the specified local name and namespace URI matches that of the current element, then reads the current element and returns the contents as a System.String object.
Returns: The element content as a System.String object.
Parameters:
  - local-name (System.String): The local name of the element.
  - namespace-uri (System.String): The namespace URI of the element.
...
(cl:defun read-element-string (obj)
  "Calls System.Xml.XmlReader.ReadElementString ReadElementString() -> String. Summary: Reads a text-only element. However, we recommend that you use the System.Xml.XmlReader.ReadElementContentAsString method instead, because it provides a more straightforward way to handle this operation.
Returns: The text contained in the element that was read. An empty string if the element is empty.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadElementString"))

(cl:defun read-element-string-string (obj name)
  "Calls System.Xml.XmlReader.ReadElementString ReadElementString(String) -> String. Summary: Checks that the System.Xml.XmlReader.Name property of the element found matches the given string before reading a text-only element. However, we recommend that you use the System.Xml.XmlReader.ReadElementContentAsString method instead, because it provides a more straightforward way to handle this operation.
Returns: The text contained in the element that was read. An empty string if the element is empty.
Parameters:
...
(cl:defun read-element-string-string-string (obj localname ns)
  "Calls System.Xml.XmlReader.ReadElementString ReadElementString(String, String) -> String. Summary: Checks that the System.Xml.XmlReader.LocalName and System.Xml.XmlReader.NamespaceURI properties of the element found matches the given strings before reading a text-only element. However, we recommend that you use the System.Xml.XmlReader.ReadElementContentAsString(System.String,System.String) method instead, because it provides a more straightforward way to handle this operation.
Returns: The text contained in the element that was read. An empty string if the element is empty.
Parameters:
  - localname (System.String): The local name to check.
  - ns (System.String): The namespace URI to check.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadElementString" localname ns))
...
(cl:defun read-start-element (obj)
  "Calls System.Xml.XmlReader.ReadStartElement ReadStartElement() -> Void. Summary: Checks that the current node is an element and advances the reader to the next node.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadStartElement"))

(cl:defun read-start-element-string (obj name)
  "Calls System.Xml.XmlReader.ReadStartElement ReadStartElement(String) -> Void. Summary: Checks that the current content node is an element with the given System.Xml.XmlReader.Name and advances the reader to the next node.
Parameters:
  - name (System.String): The qualified name of the element.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadStartElement" name))

(cl:defun read-start-element-string-string (obj localname ns)
  "Calls System.Xml.XmlReader.ReadStartElement ReadStartElement(String, String) -> Void. Summary: Checks that the current content node is an element with the given System.Xml.XmlReader.LocalName and System.Xml.XmlReader.NamespaceURI and advances the reader to the next node.
Parameters:
  - localname (System.String): The local name of the element.
  - ns (System.String): The namespace URI of the element.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadStartElement" localname ns))
...
(cl:defun read-to-descendant-string (obj name)
  "Calls System.Xml.XmlReader.ReadToDescendant ReadToDescendant(String) -> Boolean. Summary: Advances the System.Xml.XmlReader to the next descendant element with the specified qualified name.
...
(cl:defun read-to-descendant-string-string (obj local-name namespace-uri)
  "Calls System.Xml.XmlReader.ReadToDescendant ReadToDescendant(String, String) -> Boolean. Summary: Advances the System.Xml.XmlReader to the next descendant element with the specified local name and namespace URI.
...
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadToDescendant" local-name namespace-uri))
...
(cl:defun read-to-following-string (obj name)
  "Calls System.Xml.XmlReader.ReadToFollowing ReadToFollowing(String) -> Boolean. Summary: Reads until an element with the specified qualified name is found.
...
(cl:defun read-to-following-string-string (obj local-name namespace-uri)
  "Calls System.Xml.XmlReader.ReadToFollowing ReadToFollowing(String, String) -> Boolean. Summary: Reads until an element with the specified local name and namespace URI is found.
Returns: if a matching element is found; otherwise and the System.Xml.XmlReader is in an end of file state.
Parameters:
  - local-name (System.String): The local name of the element.
  - namespace-uri (System.String): The namespace URI of the element.
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadToFollowing" local-name namespace-uri))
...
(cl:defun read-to-next-sibling-string (obj name)
  "Calls System.Xml.XmlReader.ReadToNextSibling ReadToNextSibling(String) -> Boolean. Summary: Advances the to the next sibling element with the specified qualified name.
...
(cl:defun read-to-next-sibling-string-string (obj local-name namespace-uri)
  "Calls System.Xml.XmlReader.ReadToNextSibling ReadToNextSibling(String, String) -> Boolean. Summary: Advances the to the next sibling element with the specified local name and namespace URI.
Returns: if a matching sibling element is found; otherwise, . If a matching sibling element is not found, the is positioned on the end tag (System.Xml.XmlReader.NodeType is ) of the parent element.
Parameters:
...
"
  (dotnet:invoke (cl:the (dotnet "System.Xml.XmlReader") obj) "ReadToNextSibling" local-name namespace-uri))
