...
(cl:define-symbol-macro <type> (dotnet:resolve-type "System.ValueTuple`5"))
...
"
  (cl:cond
    ...
    ((cl:and (cl:or (cl:null obj) (dotnet:is-instance-of obj "System.ValueTuple`5[T1, T2, T3, T4, T5]")))
     (dotnet:invoke (cl:the (dotnet "System.ValueTuple`5") obj!) "Equals" obj))
    (cl:t (cl:error 'csharp-assembly-utils:csharp-overload-not-found
                    :package-name "SYSTEM-VALUE-TUPLE-5"
                    :class-name <type-str>
