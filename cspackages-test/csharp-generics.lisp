...
(cl:eval-when (:load-toplevel :execute)
  (cl:let* ((cls (dotnet:static "DotCL.Runtime" "EnsureDotNetTypeClass"
                  (dotnet:resolve-type "System.Text.StringBuilder")))
            (spec (cl:class-name cls)))
    ...
    (cl:eval `(cl:defmethod get-chunks ((obj! ,spec) cl:&rest args)
    ...
    (cl:eval `(cl:defmethod (cl:setf chars) (new-value (obj! ,spec) cl:&rest args)
                (cl:apply (cl:function (cl:setf system-text-string-builder:chars)) new-value obj! args)))
    (cl:eval `(cl:defmethod (cl:setf length) (new-value (obj! ,spec) cl:&rest args)
