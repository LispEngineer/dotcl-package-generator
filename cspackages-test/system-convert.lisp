...
(cl:defconstant <type> (dotnet:resolve-type "System.Convert"))
...
"
  (cl:cond
    ((cl:and (cl:or (cl:null value) (dotnet:object-type value)) (cl:or (cl:null type-code) (dotnet:object-type type-code)) supplied-provider (cl:or (cl:null provider) (dotnet:object-type provider)))
     (dotnet:static <type-str> "ChangeType" value type-code provider))
    ((cl:and (cl:or (cl:null value) (dotnet:object-type value)) (cl:or (cl:null type-code) (dotnet:object-type type-code)) supplied-provider (cl:or (cl:null provider) (dotnet:object-type provider)))
     (dotnet:static <type-str> "ChangeType" value type-code provider))
    ((cl:and (cl:or (cl:null value) (dotnet:object-type value)) (cl:or (cl:null type-code) (dotnet:object-type type-code)) (cl:not supplied-provider))
...
"
  (cl:cond
    ...
    ((cl:and (cl:or (cl:null s) (dotnet:object-type s)))
     (dotnet:static <type-str> "FromHexString" s))
    ((cl:and (cl:or (cl:null s) (dotnet:object-type s)))
     (dotnet:static <type-str> "FromHexString" s))
    (cl:t (cl:error 'csharp-assembly-utils:csharp-overload-not-found
...
"
  (cl:cond
    ((cl:and (cl:or (cl:null in-array) (dotnet:object-type in-array)) (cl:numberp offset-in) (cl:numberp length) (cl:or (cl:null out-array) (dotnet:object-type out-array)) (cl:numberp offset-out) supplied-options (cl:or (cl:null options) (dotnet:object-type options)))
     (dotnet:static <type-str> "ToBase64CharArray" in-array offset-in length out-array offset-out options))
    ((cl:and (cl:or (cl:null in-array) (dotnet:object-type in-array)) (cl:numberp offset-in) (cl:numberp length) (cl:or (cl:null out-array) (dotnet:object-type out-array)) (cl:numberp offset-out) (cl:not supplied-options))
...
"
  (cl:cond
    ((cl:and (cl:or (cl:null in-array) (dotnet:object-type in-array)) supplied-options (cl:numberp options) supplied-length (cl:numberp length) supplied-options2 (cl:or (cl:null options2) (dotnet:object-type options2)))
     (dotnet:static <type-str> "ToBase64String" in-array options length options2))
    ((cl:and (cl:or (cl:null in-array) (dotnet:object-type in-array)) supplied-options (cl:numberp options) supplied-length (cl:numberp length) (cl:not supplied-options2))
...
"
  (cl:cond
    ((cl:and (cl:stringp value) supplied-provider (cl:or (cl:null provider) (dotnet:object-type provider)))
     (dotnet:static <type-str> "ToBoolean" value provider))
    ((cl:and (cl:or (cl:null value) (dotnet:object-type value)) supplied-provider (cl:or (cl:null provider) (dotnet:object-type provider)))
     (dotnet:static <type-str> "ToBoolean" value provider))
    ((cl:and (cl:or (cl:null value) (dotnet:object-type value)) (cl:not supplied-provider))
...
"
  (cl:cond
    ((cl:and (cl:or (cl:null in-array) (dotnet:object-type in-array)) supplied-offset (cl:numberp offset) supplied-length (cl:numberp length))
     (dotnet:static <type-str> "ToHexString" in-array offset length))
    ((cl:and (cl:or (cl:null in-array) (dotnet:object-type in-array)) (cl:not supplied-offset) (cl:not supplied-length))
...
"
  (cl:cond
    ((cl:and (cl:typep value 'cl:boolean) supplied-provider (cl:or (cl:null provider) (dotnet:object-type provider)))
     (dotnet:static <type-str> "ToString" value provider))
    ((cl:and (cl:numberp value) supplied-provider (cl:or (cl:null provider) (dotnet:object-type provider)))
     (dotnet:static <type-str> "ToString" value provider))
    ((cl:and (cl:numberp value) supplied-provider (cl:or (cl:null provider) (dotnet:object-type provider)))
     (dotnet:static <type-str> "ToString" value provider))
    ((cl:and (cl:or (cl:null value) (dotnet:object-type value)) supplied-provider (cl:or (cl:null provider) (dotnet:object-type provider)))
