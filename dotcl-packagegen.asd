...
(defsystem "dotcl-packagegen"
  ...
  :components ((:file "packages")
               ...
               (:file "apg-type-checks" :depends-on ("packages"))
               (:file "apg-overload-dispatch" :depends-on ("apg-overload-signatures" "apg-type-checks"))
               ...
               (:file "package-generator-tests-obsolete" :depends-on ("package-generator-tests-support"))
               ...
               (:file "generator-tests" :depends-on ("package-generator-tests-naming"
                                                      ...
                                                      "package-generator-tests-obsolete"
